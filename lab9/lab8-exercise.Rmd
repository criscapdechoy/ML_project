...
6. Measure variable importance of the build forest with optimal parameters and compute test performance metrics of final forest
7. Fit a boosting ensemble optimizing one or two paramters of boosting (at least)
8. Measure variable importance of boosted ensemble. Does it change from what random forests say?
9. Compute test performance metrics of final boosted ensemble
10. Have you dealt with class imbalance? If not, think how you would do it in both cases. 
